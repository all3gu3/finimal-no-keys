...
// Our default route
app.get('/photos',(req,res)=>{AWS.config.update({
});
...
getImage()
    .then((img)=>{
        ...
        //console.log(img_0);
        let startHTML='<html><body><h1>lkldsk</h1><img height="200" width="200" src="https://3vnqw32fta3x1ysij926ljs3-wpengine.netdna-ssl.com/wp-content/uploads/2011/07/Coconuts.jpg"></body>';
...
getImage()
    .then((img)=>{
        let _data='data:image/jpeg;base64,' + encode(img.Body);
        document.querySelector('img').src = _data;
    })*/
